...
window.onscroll = () => {
    // Moves "X" vertically 
    document.querySelector(".X").style.marginTop = scrollY + "px";

    // Moves "pic" vertically but slower 
    document.querySelector(".pic").style.marginTop = scrollY / 1.5 + "px";

    // Moves "stars" vertically at double the scroll speed
    document.querySelector(".stars").style.marginTop = scrollY * 2 + "px";

    // Moves "stars" horizontally 
    document.querySelector(".stars").style.marginRight = scrollY / 2 + "px";

    // Rotates "text" counter-clockwise as the user scrolls
    document.querySelector(".text").style.transform = "rotate(-" + (scrollY / 5.5) + "deg)";

    // Moves the heading 
    document.querySelector(".Home h1").style.marginTop = scrollY + "px";

    // Adjusts the opacity of title
